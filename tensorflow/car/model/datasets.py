...
def moving_square(n_frames=100, return_x=True, return_y=True):
    '''
    Generate sequence of images of square bouncing around the image and labels of its coordinates. 
    Can be used as a basix simple performance test of convolution networks.
    '''
    row = 120
    col = 160
    ...
    # convert array to dtype that PIL.Image accepts and scale it to 0-256
