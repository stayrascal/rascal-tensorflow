if __name__ == '__main__':
    ...
    train_samples, train_labels = read_image('../pickle/train-n.pickle')
    test_samples, test_labels = read_image('../pickle/test-n.pickle')
    ...
    net.add_softmax_fc(in_num_nodes=32, out_num_nodes=10, activation='softmax', name='softmax1')
    net.add_softmax_fc(in_num_nodes=32, out_num_nodes=10, activation='softmax', name='softmax2')
    net.add_softmax_fc(in_num_nodes=32, out_num_nodes=10, activation='softmax', name='softmax3')
    net.add_softmax_fc(in_num_nodes=32, out_num_nodes=10, activation='softmax', name='softmax4')
    net.add_softmax_fc(in_num_nodes=32, out_num_nodes=10, activation='softmax', name='softmax5')
